...
class Order(models.Model):
    ...
    shipping_provider = models.CharField(max_length=32, blank=True)
    shipping_external_id = models.CharField(max_length=128, blank=True)
    tracking_url = models.URLField(max_length=500, blank=True)
    shipping_status_raw = models.CharField(max_length=120, blank=True)
    shipping_synced_at = models.DateTimeField(null=True, blank=True)
